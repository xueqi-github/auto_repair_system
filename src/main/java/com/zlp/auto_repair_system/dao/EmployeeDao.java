...
public class EmployeeDao {
    ...
    //员工登录
    public Employee employeeLogin(String employeeName,String password){
      Example example = new Example(Employee.class);
      example.createCriteria().andEqualTo(employeeName).andEqualTo(password);
      return employeeMapper.selectByPrimaryKey(example);
    }
}
